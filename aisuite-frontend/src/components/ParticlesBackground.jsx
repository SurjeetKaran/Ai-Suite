...
// // // another bg blue particle effect
...
//         if (dist < 150) {
//           const force = dist < 50 ? -0.5 : 0.05; // repel if very close, attract otherwise
//           p.vx += (dx / dist) * force;
//           p.vy += (dy / dist) * force;
...
///////----------------------------------------------------------another bg blue particle effect with universe background
